...
export default class {
    ...
    private async cordinateRoutes(url: Url, method: string, request: Request, response: Response) {
        ...
        for (const mountedRouter of this.mountedRouters) {
            ...
            const middlewares = mountedRouter.shouldInheritMiddlewares()? [...this.router.getMiddlewares(),
                ...mountedRouter.getMiddlewares()]: mountedRouter.getMiddlewares();
    ...
    */
    ...
    private onRequest(request: Request, response: Response, server: HttpServer | HttpsServer) {
        ...
        if (httpsConfig.enabled && !request.encrypted && httpsConfig.enforce) {
            response.redirect(
                `https://${path.join(request.hostname + ':' + httpsConfig.port, request.url as string)}`
            );
        }
    }
    ...
    */
    private initServer(server: HttpServer | HttpsServer, callback: ListenerCallback) {
        ...
        server.on('error', scopeCallback(this.onServerError, this, server))
     ...
     */
    options(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    head(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    get(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    post(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    put(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
     ...
     * @param options - route configuration object or middleware or array of middlewares
    */
    delete(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
     ...
     * @param options - route configuration object or middleware or array of middlewares
    */
    all(url: Url, callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null) {
    ...
    */
     ...
     */
    use(url: Url, middleware: Middleware | Middleware[], options: Method | Method[] | MiddlewareOptions | null = null) {
