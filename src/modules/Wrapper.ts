...
export default class Wrapper {
     ...
     */
    options(callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null): this {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    head(callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null): this {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    get(callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null): this {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    post(callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null): this {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    put(callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null): this {
     ...
     * @param options - route configuration object or middleware or array of middlewares
     */
    delete(callback: Callback, options: Middleware | Middleware[] | CallbackOptions | null = null): this {
